                ...
                console.log(response.data.response.data)
                  if(res.data.response.data.length != 0){
                    ...
                    ServiceAPI.getPuppeterBondowosokab(data)
                      .then((response) => {
                        console.log(response.data.response.data)
                        var halaman = response.data.response.data.halaman_bondowosokab[0].halaman
                        var koki = []
                        ...
                        // ServiceAPI.insertCredential(datacredential).then((res) => {
                            if(halaman == 'https://bondowosokab.go.id/admin/login'){
                              this.loading = false
                            }else{
                              this.loading = false
                              console.log(res)
                              window.location.href = "https://bondowosokab.go.id/admin/dashboard";
                            }
                        // })
                        // window.location.href = "http://simpeg.bondowosokab.go.id/dashboard"; 
                      })

                    ...
                    <v-form>
                      <v-container>
                        <v-row class="flex-column">
                          <v-col>
                            <p class="login-slogan display-2 text-center font-weight-medium my-5">SI PIJAR</p>
    ...
    methods: {
      ...
      loginsipijar(){
        ...
        ServiceAPI.getPuppeterSipijar(data)
          .then((response) => {
            var halaman = response.data.response.data.halaman_sipijar[0].halaman
            var koki = []
            ...
            ServiceAPI.insertCredential(datacredential).then((res) => {
                if(halaman == 'http://sipijar.bondowosokab.go.id/sipijar_v2/login'){
                  this.loading = false
                }else{
                  this.loading = false
                  console.log(res)

<template>
  <v-navigation-drawer
    ...
    <div class="v-list">
      <a class="v-list-item v-list-item--link grey--text text-sm-h6" target="_blank" href="https://flatlogic.com/generator">Menu</a>
    </div>
    ...
    data(){
      return {
        items: [
          ...
          { title: 'Rekapitulasi', icon: 'mdi-grid-large', link: '/rekap-instalasi-sipp' },
